...
fun HomeScreen(
    ...
    onNavigateToPreCheckInvestigation  : (String, String) -> Unit = { _, _ -> },
        ...
        Row(modifier = Modifier.fillMaxSize()) {
            ...
            Box(
                ...
                TabContent(
                    ...
                    onNavigateToPreCheckInvestigation = onNavigateToPreCheckInvestigation,
...
private fun TabContent(
    ...
    onNavigateToPreCheckInvestigation : (String, String) -> Unit,
    onNavigateToSleepGuide            : () -> Unit,
    onNavigateToFeedingGuide          : () -> Unit,
    onNavigateToMemory                : () -> Unit,
    onNavigateToNotifications         : () -> Unit,
        ...
        NavigationTab.SETTINGS -> {
            ...
            LaunchedEffect(selectedBaby?.babyId) {
                selectedBaby?.let { baby ->
                    ...
                    preCheckInvestigationViewModel.load(baby.babyId)
                }
            }
            ...
            SettingsTabContent(
                ...
                preCheckInvestigationIsSet        = preCheckInvestigationViewModel.uiState.isSet,
            )
        }
    }
}