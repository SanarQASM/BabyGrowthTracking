...
// ─────────────────────────────────────────────────────────────────────────────
// Desktop (JVM) actual implementation of MemoryLocalStorage
// Stores images in user home directory under ".babygrowth/memory_images/"
// ─────────────────────────────────────────────────────────────────────────────

actual class MemoryLocalStorage actual constructor() {

    private fun getDir(): File {
        val dir = File(System.getProperty("user.home"), ".babygrowth/memory_images")
